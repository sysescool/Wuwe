...
int main() {
  ...
  reasoning::best_of_n_runner runner({
    .generator =
      [](const reasoning::reasoning_request& request, const reasoning::best_of_n_context&) {
  ...
  wuwe::println("selected candidate {} with score {}", selected->index, selected->score->value);
