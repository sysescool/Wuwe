...
[[nodiscard]] inline std::string to_string(content_trust_level trust) {
  switch (trust) {
    case content_trust_level::system_trusted:
      return "system_trusted";
    case content_trust_level::application_trusted:
      return "application_trusted";
    case content_trust_level::model_generated:
      return "model_generated";
    case content_trust_level::retrieved_untrusted:
      return "retrieved_untrusted";
    case content_trust_level::user_supplied:
      return "user_supplied";
    case content_trust_level::tool_output:
      return "tool_output";
  }
  return "retrieved_untrusted";
}
...
[[nodiscard]] inline std::string to_string(content_source_kind source) {
  switch (source) {
    case content_source_kind::system:
      return "system";
    case content_source_kind::application:
      return "application";
    case content_source_kind::model:
      return "model";
    case content_source_kind::user:
      return "user";
    case content_source_kind::memory:
      return "memory";
    case content_source_kind::knowledge:
      return "knowledge";
    case content_source_kind::tool:
      return "tool";
    case content_source_kind::external:
      return "external";
  }
  return "external";
}

[[nodiscard]] inline bool trusted_for_system_message(content_trust_level trust) noexcept {
...
[[nodiscard]] inline content_trust_level least_trusted(
  content_trust_level lhs, content_trust_level rhs) noexcept {
...
[[nodiscard]] inline bool reserved_content_provenance_key(std::string_view key) noexcept {
  return key == "trust" || key == "source" || key == "source_id" || key == "source_uri";
}

inline void set_content_provenance(
  std::map<std::string, std::string>& metadata, const content_provenance& provenance) {
...
inline content_trust_level content_trust_from_string(const std::string& value,
  content_trust_level fallback = content_trust_level::retrieved_untrusted) noexcept {
  if (value == "system_trusted")
    return content_trust_level::system_trusted;
  if (value == "application_trusted")
    return content_trust_level::application_trusted;
  if (value == "model_generated")
    return content_trust_level::model_generated;
  if (value == "user_supplied")
    return content_trust_level::user_supplied;
  if (value == "tool_output")
    return content_trust_level::tool_output;
  if (value == "retrieved_untrusted")
    return content_trust_level::retrieved_untrusted;
  return fallback;
}
...
inline content_trust_level content_trust_from_metadata(
  ...
  return found == metadata.end() ? fallback : content_trust_from_string(found->second, fallback);
}

inline std::string render_context_boundary(
  std::string label, content_trust_level trust, std::string content) {
  ...
  return "<wuwe-context source=\"" + escape_markup(label) + "\" trust=\"" + to_string(trust) +
