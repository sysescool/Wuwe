...
public:
  ...
  result<task> send(const send_message_params& params, std::stop_token stop_token = {}) const {
  ...
  result<task> get(const task_query_params& params, std::stop_token stop_token = {}) const {
  ...
  result<task> cancel(const task_id_params& params, std::stop_token stop_token = {}) const {
...
private:
  result<task> invoke_task(
    std::string method, nlohmann::json params, std::stop_token stop_token) const {
