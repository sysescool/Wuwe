#ifndef WUWE_AGENT_RUNTIME_RUNTIME_HPP
#define WUWE_AGENT_RUNTIME_RUNTIME_HPP
...
#include <wuwe/agent/runtime/sqlite_agent_run_store.hpp>

#endif // WUWE_AGENT_RUNTIME_RUNTIME_HPP
